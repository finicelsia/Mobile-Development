...
const placeTomohon = ({ navigation }) => {
    return (
        <ImageBackground source={require('../assets/tiff.jpeg')} style={{width: '100%', height: '100%'}}>
            <View style={styles.followButton}>
            <Button 
                title="Tomohon International Flower Festival"
                onPress={() => navigation.navigate('TomohonFest1')}
           />
           </View>
        </ImageBackground>
    );
